...
import navpng from '../Images/ccp.png'; // Adjust the path for footer logo
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ backgroundColor: colors.navbg, height: '85px' }}>
        <Toolbar >
          ...
          <Button color="inherit" sx={{ fontSize: 17 }} component={Link} to="/" >Car Care Pro</Button>
          <Button color="inherit" sx={{ fontSize: 14 }} component={Link} to="/" ></Button>
          ...
          <Button color="inherit" sx={{ fontSize: 14 }} component={Link} to="/efpage">AI Support</Button>
          <Button color="inherit" sx={{ fontSize: 14 }} component={Link} to="/appointment">Appointments</Button>
          </Typography>
