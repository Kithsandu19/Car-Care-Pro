...
import footerLogo from '../Images/ccp.png'; // Adjust the path for footer logo
...
function AboutUs() {
  return (
    <div
      style={{
        background: 'linear-gradient(to left,rgb(226, 226, 226),rgb(242, 181, 13))',
          ...
          <Grid item xs={12} md={10}>
            ...
            <Box sx={{ textAlign: 'center', opacity: 0, animation: 'zoomIn 2s forwards', animationDelay: '2s' }}>
              ...
              <Typography variant="body2" sx={{ color: 'black' }}>
                &copy; {new Date().getFullYear()} Car Care Pro
              </Typography>
            </Box>
          </Grid>
        </Grid>
